...
namespace True.Kentico.Forms.Html.Extensions
{
    ...
    {
        public static IHtmlString CheckBoxFor(this KenticoForm html, IForm model, string controlName, object htmlAttributes)
        {
            var renderer = ControlRendererRegistrar.Resolve(ControlType.CheckBox);
